...
import sys
import os
# sys.path.insert(0, '/Users/imxinyi/Desktop/bench')
current_dir = os.path.dirname(os.path.abspath(__file__))
dir_1 = os.path.dirname(current_dir)
dir_2 = os.path.dirname(dir_1)
project_root = os.path.dirname(dir_2)
sys.path.insert(0, project_root)

from third_party.amt.networks.blocks.raft import (
    SmallUpdateBlock,
    coords_grid,
    BidirCorrBlock
)
from third_party.amt.networks.blocks.feat_enc import (
    SmallEncoder
)
from third_party.amt.networks.blocks.ifrnet import (
    resize,
    Encoder,
    InitDecoder,
    IntermediateDecoder
)
from third_party.amt.networks.blocks.multi_flow import (
    multi_flow_combine,
    MultiFlowDecoder
)
