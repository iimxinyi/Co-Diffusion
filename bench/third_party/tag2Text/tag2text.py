...
class Tag2Text_Caption(nn.Module):
    def __init__(self,                 
        ...
        self.vision_multi = BertModel.from_pretrained("pretrained/bert",config=q2l_config, add_pooling_layer=False)
...
def init_tokenizer():
    ...
    tokenizer = BertTokenizer.from_pretrained("pretrained/bert")
